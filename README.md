...
- **Quando o repasse vence (é o que alimenta o "a repassar"):** em duas etapas iguais, tanto para o dev quanto para a agência — **50% quando o projeto começa** (a partir da data de início) e **50% quando o cliente quita** (o recebido alcança o valor do projeto). Enquanto o projeto não começou, nada venceu. O cadastro mostra em que etapa está e quanto falta; adiantamentos podem ser lançados a qualquer momento e abatem do total.
- Se as parcelas cadastradas não fecham o valor do projeto, o cadastro avisa em vermelho: o cliente não conta como quitado e a segunda metade não vence.
