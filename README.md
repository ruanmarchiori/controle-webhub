...
**Parcela de comissão ("% só minha"):** quando uma parcela corre por fora deste painel (fica em outro sistema) e dela você recebe apenas uma comissão, preencha a porcentagem nessa parcela. O painel passa a considerar só essa fatia, **inteira sua** — o valor cheio da parcela sai da base dividida com dev e agência, que passam a ter direito apenas sobre o resto do projeto. Deixar o campo em branco (o padrão) mantém a parcela normal.
