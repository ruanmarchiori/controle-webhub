...
- **Quando o repasse vence (é o que alimenta o "a repassar"):** só quando o cliente **quita o projeto** — o que entrou precisa alcançar o valor combinado (todas as parcelas pagas **e** somando o valor do projeto), ou o pagamento à vista marcado. Se as parcelas cadastradas não fecham o valor do projeto, o cadastro avisa em vermelho: o cliente não conta como quitado e o repasse não vence. Vale igual para o dev e para a agência: nada é repassado antes da última parcela entrar. Antes disso a cota deles não conta como dívida; adiantamentos podem ser lançados normalmente e abatem do total.
